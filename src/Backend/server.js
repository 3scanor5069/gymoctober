...
const mysql = require('mysql2'); // Si usas Sequelize, este podría ser opcional
const { Sequelize, DataTypes } = require('sequelize'); // Sequelize para ORM
...
const sequelize = new Sequelize(
    process.env.JAWSDB_URL || 'mysql://root:@localhost:3306/ProyectoGym', // URL de conexión, compatible con despliegue en Heroku o local
    {
        dialect: 'mysql',
        logging: false, // Opcional: deshabilita logs de SQL en la consola
    }
);
...
// Alternativa para conexión directa con MySQL (sin Sequelize)
...
// Otras configuraciones (modelos, rutas, etc.) se agregarán aquí
...
const PlanModel = sequelize.define('planes', {
    ...
    benefits: { type: DataTypes.TEXT }, // Almacenar beneficios como JSON string
});
...
const ClienteModel = sequelize.define('client', {
    ...
    planes: { type: DataTypes.TEXT }, // Almacenar planes como JSON string
});
